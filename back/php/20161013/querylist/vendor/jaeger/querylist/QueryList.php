...
class QueryList
{
    ...
    private function _arrayConvertEncoding($arr, $toEncoding, $fromEncoding)
    {
        ...
        // if(is_string($arr)){
        // return iconv($fromEncoding, $toEncoding.'//IGNORE', $arr);
        // }
        // eval('$arr = '.iconv($fromEncoding, $toEncoding.'//IGNORE', var_export($arr,TRUE)).';$iconv=true;');
        // if(!$iconv){
        // foreach($arr as $k=>$v){
        // $arr[$k]=$this->_arrayConvertEncoding($v, $toEncoding, $fromEncoding);
        // }
        // }
        return $arr;
